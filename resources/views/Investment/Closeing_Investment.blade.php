                        ...
                        <table class="table table-striped table-hover" id="">
                            ...
                            @foreach($members as $member)
                                <tr>
                                    ...
                                    <td>{{ ucwords(date('d-m-Y', strtotime($member->created_at)))}}</td>
                                    ...
                                    <td>{{ $member->penalty != false ? $member->penalty: ucwords('0') }}</td>
                                    <td>{{ $member->discount_payment != false ? $member->discount_payment: ucwords('0') }}</td>
                                    <td>{{ $member->saving_close != false ? $member->saving_close: ucwords('0') }}</td>
                                    <td>
                                        <a href="{{ route('closeloan.details',$member->invest_no)}}">
